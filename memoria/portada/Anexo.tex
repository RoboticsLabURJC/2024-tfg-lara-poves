...
de donde ha sido obtenida. Las imágenes que no incluidas en este capítulo han sido formadas en el desarrollo de este trabajo provienen 
del mismo: \newline
...
\begin{tabular}{ | m{4cm} | m{10cm}| m{1cm} | }
    ...
    \hline
    \ref{fig:infraestructura} & \url{https://es.vecteezy.com/arte-vectorial/26112987-internet-dsl-modem-dibujos-animados-vector-ilustracion} \\
    \hline
