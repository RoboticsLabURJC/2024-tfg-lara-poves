...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{figs/Diseño/cir3.jpg}
\caption{Mapa del circuito no visto/ajustado durante el entrenamiento.}
\label{fig:cir3}
\end{figure}

En los histogramas \ref{fig:comparativa_pid}(a) se muestra la velocidad en m/s del coche autónomo y el error respecto al centro del carril en píxeles durante el circuito en el que se ajustó\footnote{\url{https://youtu.be/Me3KQ3X_n-0}} el controlador \ac{PID}, mientras que en los histogramas \ref{fig:comparativa_pid}(b) se presenta la misma información, pero en un circuito en el que no se realizó el ajuste\footnote{\url{https://youtu.be/ygVov8ERqFI}}. Los datos se recopilaron durante 30 segundos en ambos casos. En los dos circuitos, podemos ver que el coche acelera al inicio, alcanzando rápidamente una velocidad de 10 m/s, la cual se mantiene constante durante todo el recorrido. Aunque en ambos escenarios el histograma de la desviación está bastante centrado, en el circuito sin ajuste, se observan desviaciones muy elevadas, entre 35 y 45 píxeles, con una frecuencia considerable. A pesar de que el circuito dispone de curvas pronunciadas, como se observa en la Figura \ref{fig:cir3}, estas desviaciones no deberían ser tan altas, puesto que el vehículo debería mantenerse dentro de los límites del carril para garantizar una conducción segura y eficiente. Esto sugiere que un controlador \ac{PID} no es capaz de generalizar adecuadamente ante carriles cambiantes, provocando inestabilidad en la trayectoria y el comportamiento del vehículo, lo cual no es óptimo en entornos de conducción autónoma.
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{figs/Diseño/passing/train_base.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{figs/Diseño/passing/velocities.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=9cm]{figs/Diseño/passing/profiling.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{figs/Diseño/overtaken/train_lane.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{figs/Diseño/overtaken/inference_lane.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{figs/Diseño/overtaken/esquema.png}
