...
\textbf{inferencia carril + video (no he podido hacer aún porque tengo todo atope y los resultados no son los reales)}
\begin{figure}[ht]
\centering
...
\textbf{profiling, cuando libere la GPU lo hago para que sea real y en las mismas condiones que los anteriores}
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{figs/Diseño/overtaken/profiling.png}
