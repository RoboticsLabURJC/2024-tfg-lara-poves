...
def main(args):
    ...
    # Add Ego Vehicle
    transform = carla.Transform(carla.Location(x=-25.0, y=-252, z=0.5), carla.Rotation(yaw=125.0))
    ...
    #autopilot = configcarla.traffic_manager(client=client, vehicles=[ego_vehicle])
