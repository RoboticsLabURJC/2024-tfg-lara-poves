...
def main():
    # Setup 
    world, client = configcarla.setup_carla(name_world='Town05', port=2000, delta_seconds=0.05)
    ...
    tm = configcarla.traffic_manager(client=client, vehicles=vehicles, dist=4.0)
