...
last_modified_at: 2024-05-22T21:22:00
categories:
  - Blog
tags:
...
- **Métodos combinados**: aprende una política encargada se seleccionar la mejor acción acciones, pero también aprenden una función de valor. Integrar la función de valor en el proceso proporciona más información a la política que solo las recompensas.
...
Hemos creado un programa en python para crear y entrenar un modelo para cuatro entorno de gym específicos y otro para probar dicho modelo. Los resultados podemos visualizarlos directamente con el comando *comado*.
```bash
python3 train.py

python3 play.py
```
info de cada juego: estado + objetivo:
- **CartPole**:cada estado incluye la posición y velocidad del carro, el ángulo del palo y la velocidad angular del palo

Comentar las comparciones de las gráficas con los diferentes algoritmos uitilizados
<figure class="align-center" style="max-width: 100%">
  <img src="{{ site.url }}{{ site.baseurl }}/images/RL/gym_results.png" alt="">
</figure>